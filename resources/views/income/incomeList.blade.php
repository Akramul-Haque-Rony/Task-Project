            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="?">Income List</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('income.create') }}"><u>Add New</u></a>
                        </li>
                    </ol>
                </div>
            </div>
                                    ...
                                    @if ($data->count() > 0)
                                        @foreach ($data as $key => $datas)
                                            ...
                                            <div class="modal fade" id="modal-BrandEdit-{{$key}}">
                                                <form role="form" method="POST" action="{{ route('income.update', ['id' => $datas->id]) }}">
                                                    @csrf
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Edit {{ @$datas->CustomerInfo->name}}</h4>
